...
Easiest to install by pip UnitTesterSG, or pip UnitTesterSG[COMPLETE] which will include color printing for passed and failed tests (https://pypi.org/project/UnitTesterSG/). After installation, navigate the directory from https://github.com/AdityaSavara/UnitTesterSG/ to run the examples.
