...
You can create an expected results file ahead of time.  More typically, you would check manually that your function is working the first time, and then you would run this module.
Initially, there will be no "expected results" to check against, so after you have your function working correctly, and have verified that the output is as expected, you should run 
your function and then choose the "Y" option which will store the results.  Then, in the future, you can check against those stored results by copying the directory and replacing 
